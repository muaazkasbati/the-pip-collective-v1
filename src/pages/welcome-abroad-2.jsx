...
//                             className="text-[24px] sm:text-[48px] md:text-[75px] leading-none font-medium sm:mb-4 mb-2"
//                         >
//                             Next Steps To Get FREE Access
//                         </motion.h1>
...
//                         >
//                             Check your inbox – we’ve just sent you the next steps to get access.
//                         </motion.h2>
...
//                 </motion.div>
//             </section>
//             <div className="text-center max-w-7xl mx-auto px-4 md:px-0 pb-12">
//                 <h3 className="text-[15px] md:text-[36px] capitalize font-bold mb-9 leading-tight">
//                     The Broker sign-up plan requires you to create and fund a LIVE account with One Of our partnered brokers
//                 </h3>
//                 <h4 className="text-[13px] md:text-[40px] font-normal mb-5 leading-none">
//                     Use One Of The Broker Links Below To <br />Create & Fund Your Live Account
//                 </h4>
...
//                 <div className="">
//                     <h3 className="text-[15px] sm:text-[40px] font-bold my-5">Get Started <span className="bg-[linear-gradient(90deg,_rgba(171,_0,_212,_1)_0%,_rgba(129,_27,_192,_1)_23%,_rgba(93,_61,_187,_1)_58%,_rgba(4,_154,_203,_1)_100%)] bg-clip-text text-transparent">3 Simple Steps</span></h3>
//                     <div className="grid grid-cols-1 md:grid-cols-3 sm:gap-8 gap-2">
...
//                         <div className="bg-[#1b1b1b] p-4 rounded-md">
//                             <h4 className="font-bold text-[13px] sm:text-[18px]">
//                                 <span className="bg-[linear-gradient(90deg,_rgba(171,_0,_212,_1)_0%,_rgba(129,_27,_192,_1)_23%,_rgba(93,_61,_187,_1)_58%,_rgba(4,_154,_203,_1)_100%)] bg-clip-text text-transparent">Step 3:</span>
//                             </h4>
//                             <p className="mt-2 text-[10px] sm:text-[16px] text-white">
...
//                 </div>
//             </div>
//             <div className="text-center my-10 max-w-7xl mx-auto sm:px-0 px-4">
//                 <h3 className="text-[15px] sm:text-[40px] leading-tight font-bold mb-4">
//                     Already have an account? No problem!
//                 </h3>
//                 <p className="text-[12px] sm:text-[24px] md:text-[36px] leading-none font-light mb-6 bg-[linear-gradient(90deg,_rgba(171,_0,_212,_1)_0%,_rgba(129,_27,_192,_1)_23%,_rgba(93,_61,_187,_1)_58%,_rgba(4,_154,_203,_1)_100%)] bg-clip-text text-transparent">
//                     Join our discord server using the link below, create a support ticket <br className="sm:block hidden" />and our team will discuss your options and next steps.
//                 </p>
//                 <p className="text-[10px] sm:text-[20px] leading-tight capitalize underline underline-offset-1 font-extrabold mb-4">
//                     Unfortunately, we're unable to offer this plan to members residing in any of the <br className="sm:block hidden" />countries listed above, as our partnered broker does not support them.
//                 </p>
        ...
        <div className="welcomeAbroad">
            ...
            <section className="sm:pt-36 pt-22 relative overflow-hidden">
                <motion.div
                    ...
                    animate={{ opacity: 1, y: 0 }}
                    transition={{ duration: 0.8, ease: "easeOut" }}
                    className="text-white relative container max-w-7xl mx-auto md:px-0 px-4 z-10 text-center"
                >
                    <motion.h1
                        initial={{ opacity: 0, y: 20 }}
                        animate={{ opacity: 1, y: 0 }}
            ...
            <section className="pb-2 px-4">
                <motion.div
                    ...
                    viewport={{ once: true }}
                    transition={{ duration: 0.8 }}
                    className="text-white relative container max-w-7xl mx-auto text-center"
                >
                    <div
                        className="w-full max-w-[1000px] h-[200px] sm:h-[350px] md:h-[550px] rounded-[20px] overflow-hidden relative mx-auto mb-8"
                        onClick={() => setIsPlaying(true)}
            ...
            {/* BROKER PLAN SECTION */}
            <section className="text-center max-w-7xl mx-auto px-4 md:px-0 pb-12">
                <h3 className="text-[15px] md:text-[36px] capitalize font-bold mb-9 leading-tight">
                    The Broker sign-up plan requires you to create and fund a LIVE account with One Of our partnered brokers
                </h3>
                <h4 className="text-[13px] md:text-[40px] font-normal mb-5 leading-none">
                ...
                <div className="flex flex-row justify-center gap-4">
                    <button className="primaryBtn" onClick={() => setIsModalOpen(true)}>
                        Create My Account With PUPrime
                    </button>
                    <button className="primaryBtn" onClick={() => setIsModalOpen(true)}>
                        Create My Account With Vantage Markets
                    </button>
                </div>
            </section>

            {/* 3 STEPS SECTION */}
            <section className="max-w-7xl mx-auto px-8 sm:px-0">
                <h3 className="text-[15px] sm:text-[40px] font-bold my-5">
                    Get Started{" "}
                    <span className="bg-[linear-gradient(90deg,_rgba(171,_0,_212,_1)_0%,_rgba(129,_27,_192,_1)_23%,_rgba(93,_61,_187,_1)_58%,_rgba(4,_154,_203,_1)_100%)] bg-clip-text text-transparent">
                        3 Simple Steps
                    </span>
                </h3>
                <div className="grid grid-cols-1 md:grid-cols-3 sm:gap-8 gap-2">
            ...
            <section className="text-center my-10 max-w-7xl mx-auto sm:px-0 px-4">
                <h3 className="text-[15px] sm:text-[40px] leading-tight font-bold mb-4">
                    Already have an account? No problem!
                </h3>
                <p className="text-[12px] sm:text-[24px] md:text-[36px] leading-none font-light mb-6 bg-[linear-gradient(90deg,_rgba(171,_0,_212,_1)_0%,_rgba(129,_27,_192,_1)_23%,_rgba(93,_61,_187,_1)_58%,_rgba(4,_154,_203,_1)_100%)] bg-clip-text text-transparent">
                    Join our discord server using the link below, create a support ticket{" "}
                    <br className="sm:block hidden" />
                    and our team will discuss your options and next steps.
                </p>
                <p className="text-[10px] sm:text-[20px] leading-tight capitalize underline underline-offset-1 font-extrabold mb-4">
                    Unfortunately, we're unable to offer this plan to members residing in any of the{" "}
                    <br className="sm:block hidden" />
            ...
            {/* FOOTER */}
            <FooterAbroad />
            <footer className="flex flex-row justify-between items-center gap-y-4 mb-5 mx-4 lg:mx-10 relative z-10 text-center">
                <img src="./images/pip-logo.svg" alt="Logo" className="sm:w-[204px] w-[80px]" />
                <p className="text-[#898989] sm:text-[16px] text-[8px] mb-0">©2025 All Rights Reserved by NexaAIst</p>
                <div className="flex flex-col md:flex-row gap-1 sm:gap-6">
                    <p className="text-[#898989] sm:text-[16px] text-[8px] mb-0">Terms of Service</p>
            ...
            {isModalOpen && (
                <div className="fixed inset-0 bg-black/80 pt-22 flex items-start justify-center z-50">
                    <div className="bg-white/5 text-center backdrop-blur-2xl shadow-[0_0_8px_rgba(255,255,255,0.5)] p-4 sm:p-12 rounded-[18px] max-w-[300px] sm:max-w-7xl w-full relative">
                        ...
                        <p className="text-[6px] sm:text-[18px] md:text-[20px] mb-8 font-medium bg-[linear-gradient(90deg,_rgba(171,_0,_212,_1)_0%,_rgba(129,_27,_192,_1)_23%,_rgba(93,_61,_187,_1)_58%,_rgba(4,_154,_203,_1)_100%)] bg-clip-text text-transparent ">
                            Once done, youll see next steps to join us for FREE + $200 cashback.
                        </p>

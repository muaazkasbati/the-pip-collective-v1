...
export default function WelcomAbroad2() {
    ...
    return (
        <div className="welcomeAbroad">
            <Head>
                <title>BROKER PLAN WELCOME - ThePipCollective</title>
            </Head>
                ...
                <div className="grid grid-cols-1 md:grid-cols-3 sm:gap-8 gap-2">
                    <div className="bg-[#1b1b1b] p-4 rounded-md">
                        ...
                        <p className="mt-2 text-[10px] sm:text-[16px] text-white">
                            Use One of the links above to create a Live MT5 account with one of our trusted brokers.
                        </p>
                    </div>
                    ...
                    <div className="bg-[#1b1b1b] p-4 rounded-md">
                        ...
                        <p className="mt-2 text-[10px] sm:text-[16px] text-white">
                            Once created, fund the account with a minimum $1000 USD.
                        </p>
                    </div>
                    ...
                    <div className="bg-[#1b1b1b] p-4 rounded-md">
                        ...
                        <p className="mt-2 text-[10px] sm:text-[16px] text-white">
                            Join our discord server, open a support ticket and our team will get you setup.
                        </p>
                    </div>
                </div>
            </section>
            ...
            <section className="text-center my-10 max-w-7xl mx-auto sm:px-0 px-4">
                ...
                <p className="text-[12px] sm:text-[24px] md:text-[36px] leading-none font-light mb-6 pb-1 bg-[linear-gradient(90deg,_rgba(171,_0,_212,_1)_0%,_rgba(129,_27,_192,_1)_23%,_rgba(93,_61,_187,_1)_58%,_rgba(4,_154,_203,_1)_100%)] bg-clip-text text-transparent">
